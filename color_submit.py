...
def run_submit():
    ...
    out_dir  = RESULTS_DIR + '/color'
    initial_checkpoint = \
        RESULTS_DIR + '/color/checkpoint/00019500_model.pth'
        ##
...
def run_npy_to_sumbit_csv():
    ...
    submit_dir  = \
        '/home/chicm/ml/kaggle/dsb2018/results/color/submit'


    npy_dir = submit_dir  + '/npys'
    csv_file = submit_dir + '/submission-12.csv'
